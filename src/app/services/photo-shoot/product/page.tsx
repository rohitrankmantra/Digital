...
const features = [
  ...
  },
  {
    ...
    description: "Product photos in real-life settings",
  },
  {
    icon: <FaStar size={28} />,
    title: "360° Views",
...
const process = [
  {
    step: "01",
    title: "Planning",
    description: "Discuss goals and plan the shoot",
  },
  {
    step: "02",
    title: "Setup",
    description: "Prepare the studio and equipment",
  },
  {
    step: "03",
    title: "Shoot",
    description: "Capture stunning product photos",
  },
  {
    step: "04",
    title: "Editing",
  ...
  },
  {
    step: "05",
    title: "Delivery",
    description: "Deliver high-quality final images",
  },
];

const stats = [
  { value: 5000, label: "Products Photographed", suffix: "+" },
  { value: 98, label: "Client Satisfaction", suffix: "%" },
  { value: 200, label: "Happy Brands", suffix: "+" },
          ...
          <div className="grid gap-14 lg:grid-cols-[1fr_1fr] items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-9">
                Professional product photography that showcases your products in the best light and drives sales.
              </p>
              <Link
                href="/contact"

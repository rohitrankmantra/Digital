...
const features = [
  {
    ...
    description: "Acquire high-quality backlinks from authoritative sites",
  },
  {
    icon: <Sparkles size={28} />,
    title: "Guest Posting",
    description: "Publish content on relevant industry websites",
  },
  {
    icon: <Target size={28} />,
    title: "Influencer Outreach",
    description: "Connect with influencers to boost your brand",
  },
  {
    icon: <Globe size={28} />,
    title: "Brand Mentions",
    description: "Increase your brand's online visibility and reputation",
  },
];
...
const process = [
  {
    step: "01",
    title: "Research",
    description: "Identify relevant websites and influencers in your niche",
  },
  {
    step: "02",
    title: "Outreach",
    description: "Connect with website owners and build relationships",
  },
  {
    step: "03",
    title: "Content Creation",
    description: "Create valuable content for guest posting",
  },
  {
    step: "04",
    title: "Link Building",
  ...
  },
  {
    step: "05",
    title: "Monitoring",
    description: "Track backlinks and adjust strategy",
  },
];

const stats = [
  { value: 2000, label: "Backlinks Built", suffix: "+" },
  { value: 500, label: "Guest Posts Published", suffix: "+" },
  { value: 150, label: "Influencer Collaborations", suffix: "+" },
  { value: 90, label: "Domain Authority Increase", suffix: "+" },
];
          ...
          <div className="grid gap-14 lg:grid-cols-[1fr_1fr] items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-black mb-7 font-[Montserrat] leading-tight">
                Build Authority with Strategic Off-Page SEO
              </h1>
              <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-9">
                Boost your domain authority and search rankings with our comprehensive off-page SEO services, including backlink building, guest posting, and influencer outreach.
              </p>
              <Link
                href="/contact"

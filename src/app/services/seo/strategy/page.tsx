...
const features = [
  {
    ...
    description: "Identify high-value keywords that drive targeted traffic",
  },
  {
    icon: <TrendingUp size={28} />,
    title: "Competitor Analysis",
    description: "Analyze competitors to find opportunities and gaps",
  },
  {
  ...
  },
  {
    ...
    description: "Monitor progress and adjust strategies for optimal results",
  },
];
...
const process = [
  ...
  },
  {
    step: "02",
    title: "Research",
    description: "Analyze keywords, competitors, and market trends",
  },
  {
    step: "03",
    title: "Strategy",
    description: "Develop a custom SEO strategy tailored to your needs",
  },
  {
    step: "04",
    title: "Implementation",
    description: "Execute the strategy and optimize your website",
  },
  {
    step: "05",
    title: "Monitoring",
...
const stats = [
  { value: 300, label: "SEO Clients", suffix: "+" },
  { value: 95, label: "Success Rate", suffix: "%" },
  { value: 2500, label: "Keywords Ranked", suffix: "+" },
          ...
          <div className="grid gap-14 lg:grid-cols-[1fr_1fr] items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-black mb-7 font-[Montserrat] leading-tight">
                Strategic SEO That Drives Real Results
              </h1>
              <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-9">
                Our comprehensive SEO strategy services help you rank higher, attract more qualified traffic, and grow your business sustainably.
              </p>
              <Link
                href="/contact"
